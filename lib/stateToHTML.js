...
var CODE = _draftJsTools.INLINE_STYLE.CODE;
var ITALIC = _draftJsTools.INLINE_STYLE.ITALIC;
var STRIKETHROUGH = _draftJsTools.INLINE_STYLE.STRIKETHROUGH;
var UNDERLINE = _draftJsTools.INLINE_STYLE.UNDERLINE;
...
var INLINE_STYLE_TO_TAG = (_INLINE_STYLE_TO_TAG = {}, _defineProperty(_INLINE_STYLE_TO_TAG, BOLD, 'strong'), _defineProperty(_INLINE_STYLE_TO_TAG, CODE, 'code'), _defineProperty(_INLINE_STYLE_TO_TAG, ITALIC, 'em'), _defineProperty(_INLINE_STYLE_TO_TAG, STRIKETHROUGH, 'del'), _defineProperty(_INLINE_STYLE_TO_TAG, UNDERLINE, 'ins'), _INLINE_STYLE_TO_TAG);

// The reason this returns an array is because a single block might get wrapped
// in two tags.
function getTags(blockType) {
  switch (blockType) {
    case _draftJsTools.BLOCK_TYPE.HEADER_ONE:
      return ['h1'];
    case _draftJsTools.BLOCK_TYPE.HEADER_TWO:
      return ['h2'];
    case _draftJsTools.BLOCK_TYPE.HEADER_THREE:
      return ['h3'];
    case _draftJsTools.BLOCK_TYPE.HEADER_FOUR:
      return ['h4'];
    case _draftJsTools.BLOCK_TYPE.HEADER_FIVE:
      return ['h5'];
    case _draftJsTools.BLOCK_TYPE.HEADER_SIX:
      return ['h6'];
    case _draftJsTools.BLOCK_TYPE.UNORDERED_LIST_ITEM:
    case _draftJsTools.BLOCK_TYPE.ORDERED_LIST_ITEM:
      return ['li'];
    case _draftJsTools.BLOCK_TYPE.BLOCKQUOTE:
      return ['blockquote'];
    case _draftJsTools.BLOCK_TYPE.CODE:
      return ['pre', 'code'];
    default:
      return ['p'];
  }
...
var MarkupGenerator = function () {
  ...
  _createClass(MarkupGenerator, [{
    ...
    value: function renderBlockContent(block) {
      ...
      var entityPieces = (0, _draftJsTools.getEntityRanges)(text, charMetaList);
      // Merge core tag map with user provided map
      var tagMap = _extends({}, INLINE_STYLE_TO_TAG, this.options.inlineTags);
      return entityPieces.map(function (_ref) {
        ...
        var content = stylePieces.map(function (_ref3) {
          ...
          var styleTypes = Object.keys(tagMap);
          styleTypes.forEach(function (styleType) {
          ...
          if (style.has(CODE)) {
            ...
            content = blockType === _draftJsTools.BLOCK_TYPE.CODE ? content : '<' + tagMap[CODE] + '>' + content + '</' + tagMap[CODE] + '>';
          }
          return content;
        }).join('');
        var entity = entityKey ? _draftJs.Entity.get(entityKey) : null;
        var entityType = entity == null ? null : entity.getType();
        if (entityType != null && entityType === _draftJsTools.ENTITY_TYPE.LINK) {
